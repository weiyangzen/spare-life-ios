...
enum ChatSenderRole: String, Hashable {
    ...
    var bubbleColor: Color {
        ...
        case .myPersona:    return .spareYellowLight
        case .theirHuman:   return Color(.secondarySystemGroupedBackground)
        case .theirPersona: return .spareYellowWash
        case .agentHelper:  return Color.spareYellow.opacity(0.14)
...
final class ConversationHubStore: ObservableObject {
    ...
    static func mockThreads() -> [ConversationThread] {
        [
            ConversationThread(
                id: "t1", contactName: "Dubi", avatarSeed: 2, kind: .human,
            ...
            ConversationThread(
                id: "t2", contactName: "Sophie", avatarSeed: 5, kind: .quadRole,
            ...
            ConversationThread(
                id: "t3", contactName: "Omar & Aris(群)", avatarSeed: 8, kind: .group,
            ...
            ConversationThread(
                id: "t4", contactName: "Mia", avatarSeed: 1, kind: .human,
            ...
            ConversationThread(
                id: "t5", contactName: "Hannah", avatarSeed: 3, kind: .agentDirect,
